Instance: test-udap-random-stranger
InstanceOf: TestScript
Usage: #example
* url = "http://hl7.org/fhir/TestScript/consent-engine"
* version = "1.0"
* name = "Consent Engine Script"
* status = #draft
* experimental = true
* date = "2021-11-08"
* publisher = "HL7"
...
* fixture[0].id = "fixture-patient-create-jennifer-smith"
* fixture[=].autocreate = true
* fixture[=].autodelete = false
* fixture[=].resource = Reference(Patient/jennifer-smith) "Jennifer Smith"
* fixture[+].id = "fixture-patient-create-random-stranger"
* fixture[=].autocreate = true
* fixture[=].autodelete = false
* fixture[=].resource = Reference(Patient/random-stranger) "Random Stranger"
* profile.id = "patient-profile"
* profile = Reference(http://hl7.org/fhir/StructureDefinition/Patient)
* variable[0].name = "createJenniferSmith"
* variable[=].path = "Patient/id"
* variable[=].sourceId = "fixture-patient-create-jennifer-smith"
* variable[+].name = "createRandomStranger"
* variable[=].path = "Patient/id"
* variable[=].sourceId = "fixture-patient-create-random-stranger"
...
* setup.action[=].operation.resource = #Patient
* setup.action[=].operation.label = "SetupDeleteRandomStranger"
* setup.action[=].operation.description = "Execute a delete operation to insure the random stranger record does not exist on the server."
* setup.action[=].operation.accept = #json
* setup.action[=].operation.encodeRequestUrl = true
* setup.action[=].operation.params = "/${createRandomStranger}"
* setup.action[+].assert.description = "Confirm that the returned HTTP status is 200(OK) or 204(No Content)."
* setup.action[=].assert.direction = #response
* setup.action[=].assert.operator = #in
* setup.action[=].assert.responseCode = "200,204"
...
* setup.action[=].operation.resource = #Patient
* setup.action[=].operation.label = "SetupCreatePatient"
* setup.action[=].operation.description = "Create Random Stranger on test script"
* setup.action[=].operation.accept = #json
* setup.action[=].operation.contentType = #json
* setup.action[=].operation.encodeRequestUrl = true
* setup.action[=].operation.params = "/${createRandomStranger}"
* setup.action[=].operation.sourceId = "fixture-patient-create-random-stranger"
* setup.action[+].assert.description = "Confirm that the returned HTTP status is 201(Created)."
* setup.action[=].assert.direction = #response
* setup.action[=].assert.responseCode = "201"
* setup.action[=].assert.warningOnly = false
...
* test[+].id = "02-ReadRandomStranger"
* test[=].name = "Read Random Stranger (Fail)"
* test[=].description = "Jessica should not be able to access or read the record of a random stranger."
* test[=].action[0].operation.type = http://terminology.hl7.org/CodeSystem/testscript-operation-codes#read
* test[=].action[=].operation.resource = #Patient
* test[=].action[=].operation.description = "Read the patient resource on the test server using the id from fixture-patient-create-random-stranger."
* test[=].action[=].operation.encodeRequestUrl = false
* test[=].action[=].operation.responseId = "fixture-patient-read"
* test[=].action[=].operation.targetId = "fixture-patient-create-random-stranger"
* test[=].action[+].assert.label = "02-ReadRandomStrangerFail"
* test[=].action[=].assert.description = "Confirm that the returned HTTP status is 401(OK)."
* test[=].action[=].assert.direction = #response
* test[=].action[=].assert.response = #forbidden
* test[=].action[=].assert.warningOnly = false
* teardown.action[0].operation.type = http://terminology.hl7.org/CodeSystem/testscript-operation-codes#delete
...
* teardown.action[=].operation.resource = #Patient
* teardown.action[=].operation.description = "Delete the Random Stranger patient resource on the test server using the id from fixture-patient-create-random-stranger."
* teardown.action[=].operation.encodeRequestUrl = true
* teardown.action[=].operation.targetId = "fixture-patient-create-random-stranger"