Instance: TestScript-Scenario1A
InstanceOf: TestScript
Description: "R4 TestScript - Directories with Anonymous Access (Work in Progress)"
Title: "Scenario 1A"
Usage: #example
* url = "http://"
* status = #draft
* name = "Scenario 1A"
* title = "R4 TestScript - Directories With Restricted Data"
