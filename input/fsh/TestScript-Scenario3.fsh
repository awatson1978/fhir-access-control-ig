...
Description: "R4 TestScript - Clinicians Can Access Any Patients Their Role Authorizes"
Title: "Scenario 3"
Usage: #example
* url = "http://"
* status = #draft
* name = "Scenario 3"
* title = "R4 TestScript - Clinicians Can Access Any Patients Their Role Authorizes"
