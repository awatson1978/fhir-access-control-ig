Instance: TestScript-Scenario2D
InstanceOf: TestScript
Description: "R4 TestScript - PHI System - General Practitioner Access (Work in Progress)"
Title: "Scenario 2D"
Usage: #example
* url = "http://"
* status = #draft
* name = "Scenario 2D"
* title = "R4 TestScript - PHI System - General Practitioner Access"
