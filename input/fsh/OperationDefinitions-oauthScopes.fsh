...
* description = "Return a list of OAuth scopes"
...
* base = "OperationDefinition/Consent-oauthScopes"
* resource = #Consent
* system = false
* type = false
* instance = true
...
* parameter[=].min = 1
* parameter[=].max = "1"
* parameter[=].documentation = "Usage:  GET /Consent/$oauthScopes?patient=Patient/{patientId}"
...
* parameter[=].min = 0
* parameter[=].max = "1"
* parameter[=].documentation = "Usage:  GET /Consent/$oauthScopes?consentor=RelatedPerson/{relatedPersonId}"
* parameter[=].type = #Reference
...
* parameter[=].min = 0
* parameter[=].max = "1"
* parameter[=].documentation = "Usage:  GET /Consent/$oauthScopes?practitioner=Practitioner/{practitionerId}"
* parameter[=].type = #Reference
...
* parameter[=].min = 0
* parameter[=].max = "1"
* parameter[=].documentation = "Usage:  GET /Consent/$oauthScopes?organization=Organization/{organizationId}"
* parameter[=].type = #Reference
