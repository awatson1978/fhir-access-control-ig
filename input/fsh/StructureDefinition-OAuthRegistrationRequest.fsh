Resource: OAuthRegistrationRequest
...
// Instance: registration-request-1
// InstanceOf: OAuthRegistrationRequest
// Description: "Registration attempt 1"
// Usage: #example
...
// // * redirect_uris[0] = "https://inferno.healthit.gov/community/oauth2/static/redirect"

// * redirect_uris.label 1..1 string "Short, human-readable label to display for the source." "A short, human-readable label to display for the source of the information displayed on this card. If a url is also specified, this MAY be the text for the hyperlink."
...
// * systemActions ^contentReference = "http://hl7.org/fhir/tools/StructureDefinition/OAuthRegistrationRequest#OAuthRegistrationRequest.cards.suggestions.actions"
