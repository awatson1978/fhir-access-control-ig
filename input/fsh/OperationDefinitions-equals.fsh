...
* parameter[=].min = 1
* parameter[=].max = "1"
* parameter[=].documentation = "Usage:  GET /Consent/$equals?patient=Patient/{patientId}"
...
// * parameter[=].min = 0
// * parameter[=].max = "1"
// * parameter[=].documentation = "Usage:  GET /Consent/$equals?consentor=RelatedPerson/{relatedPersonId}"
// * parameter[=].type = #Reference
...
// * parameter[=].min = 0
// * parameter[=].max = "1"
// * parameter[=].documentation = "Usage:  GET /Consent/$equals?practitioner=Practitioner/{practitionerId}"
// * parameter[=].type = #Reference
...
// * parameter[=].min = 0
// * parameter[=].max = "1"
// * parameter[=].documentation = "Usage:  GET /Consent/$equals?organization=Organization/{organizationId}"
// * parameter[=].type = #Reference
