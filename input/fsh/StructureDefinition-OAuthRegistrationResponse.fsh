Logical: OAuthRegistrationResponse
Id: OAuthRegistrationResponse
Title: "OAuth Registration Response"
Description: "This structure is defined to allow the FHIR Validator to validate a OAuthRegistration Response body"
* ^url = "http://hl7.org/fhir/tools/StructureDefinition/OAuthRegistrationResponse"
* ^version = "0.1.0"
* ^status = #draft
...
* client_name 1..1 string "Client name."
...
// * systemActions ^contentReference = "http://hl7.org/fhir/tools/StructureDefinition/OAuthRegistrationResponse#OAuthRegistrationResponse.cards.suggestions.actions"
