...
* version = "B"
* name = "Consent To Access Control List"
* status = #draft
* kind = #operation
* date = "2015-08-04"
...
* description = "Return the access control list for a user."
...
* base = "OperationDefinition/Consent-toAcl"
* resource = #Consent
* system = false
* type = false
* instance = true
...
* parameter[=].min = 1
* parameter[=].max = "1"
* parameter[=].documentation = "Usage:  GET /Consent/$toAcl?patient=Patient/{patientId}"
...
* parameter[=].min = 0
* parameter[=].max = "1"
* parameter[=].documentation = "Usage:  GET /Consent/$toAcl?consentor=RelatedPerson/{relatedPersonId}"
* parameter[=].type = #Reference
...
* parameter[=].min = 0
* parameter[=].max = "1"
* parameter[=].documentation = "Usage:  GET /Consent/$toAcl?practitioner=Practitioner/{practitionerId}"
* parameter[=].type = #Reference
...
* parameter[=].min = 0
* parameter[=].max = "1"
* parameter[=].documentation = "Usage:  GET /Consent/$toAcl?organization=Organization/{organizationId}"
* parameter[=].type = #Reference
