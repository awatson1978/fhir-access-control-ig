...
* parameter[=].min = 1
* parameter[=].max = "1"
* parameter[=].documentation = "Usage:  GET /Consent/$parseToBundle?patient=Patient/{patientId}"
...
* parameter[=].min = 0
* parameter[=].max = "1"
* parameter[=].documentation = "Usage:  GET /Consent/$parseToBundle?consentor=RelatedPerson/{relatedPersonId}"
* parameter[=].type = #Reference
...
* parameter[=].min = 0
* parameter[=].max = "1"
* parameter[=].documentation = "Usage:  GET /Consent/$parseToBundle?practitioner=Practitioner/{practitionerId}"
* parameter[=].type = #Reference
...
* parameter[=].min = 0
* parameter[=].max = "1"
* parameter[=].documentation = "Usage:  GET /Consent/$parseToBundle?organization=Organization/{organizationId}"
* parameter[=].type = #Reference
