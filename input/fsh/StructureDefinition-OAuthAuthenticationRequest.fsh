...
// * systemActions ^contentReference = "http://hl7.org/fhir/tools/StructureDefinition/OAuthAuthenticationRequest#OAuthAuthenticationRequest.cards.suggestions.actions"
