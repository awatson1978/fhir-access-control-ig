...
// * systemActions ^contentReference = "http://hl7.org/fhir/tools/StructureDefinition/OAuthAuthenticationResponse#OAuthAuthenticationResponse.cards.suggestions.actions"
