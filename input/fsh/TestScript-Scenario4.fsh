Instance: TestScript-Scenario4
InstanceOf: TestScript
Description: "R4 TestScript - Patients Can Access Dependent’s Records (Custodial Access)"
Title: "Scenario 4"
Usage: #example
* url = "http://"
* status = #draft
* name = "Scenario 4"
* title = "R4 TestScript - Patients Can Access Dependent’s Records (Custodial Access)"
