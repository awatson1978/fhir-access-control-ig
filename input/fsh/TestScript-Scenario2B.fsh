Instance: TestScript-Scenario2B
InstanceOf: TestScript
Description: "R4 TestScript - PHI System - Patient Self Access (Work in Progress)"
Title: "Scenario 2B"
Usage: #example
* url = "http://"
* status = #draft
* name = "Scenario 2B"
* title = "R4 TestScript - PHI System - Patient Self Access"
